...
Legend: ✅ done · ⏳ planned / not yet authored. SPL and KQL translations are auto-generated by the [Sigma CI pipeline](.github/workflows/sigma-lint.yml) in Phase 4; the columns track that work.
...
The `T1021_002_smb_lateral_movement.yml` rule is finalized (real UUID, authored FP profile); the remaining rules are scaffolded stubs being hardened in Phase 4. ATT&CK Navigator layer is generated in Phase 4.
